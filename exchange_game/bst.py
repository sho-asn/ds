...
class BinarySearchTree(Generic[K, I]):
    ...
    def get_successor(self, current: TreeNode) -> TreeNode:
        """
            ...
            Approach Taken:
            The successor is bigger than current however it is the smallest biggest one after current.
            This method returns the node that is a child node having the smallest key among all the larger keys.
            Since the key is in the most right-hand-side of the sub-tree, it loops until the current reaches there.

            Worst Case Time Complexity :
            O(n), where n is the depth of the tree when it is in the farthest place from the root.
        """
    ...
    def get_minimal(self, current: TreeNode) -> TreeNode:
        """
            ...
            Approach Taken:
            This method returns the node that is having the smallest key in the current subtree.
            Since the smallest key is in the most left-hand-side node, it loops until the current reaches there.
